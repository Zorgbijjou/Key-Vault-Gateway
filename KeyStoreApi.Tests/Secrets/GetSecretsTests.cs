...
public class GetSecretsTests {
    ...
    public async Task Happy() {
        ...
        // Act
        var ep = Factory.Create<GetSecretEndpoint>(new SecretService(mock), _err);
        ...
        ep.Response.Secret.Should().Be("Value1");
    }
